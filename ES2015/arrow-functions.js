...
var tripleAndFilter = arr => arr.map(n => n * 3).filter(i => i % 5 === 0)
...
var doubleOddNumbers = arr => arr.filter(i => i % 2 !== 0).map(i => i * 2)
...
var mapFilterAndReduce = arr => arr.map(obj => obj.firstName)
...
var createStudentObj2 = (first, last) => ({
    firstName: first,
    lastName: last
})
